...
{
    private static readonly ConcurrentDictionary<PropertyInfo, FastProperty> FastPropertyCache = new ConcurrentDictionary<PropertyInfo, FastProperty>();
...
#pragma warning disable CS1591 // No XML comment required here
    ...
    {
        if (value != default && _setDelegate != null)
        {
